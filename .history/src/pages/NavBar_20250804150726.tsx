      ...
      <div className="max-w-6xl mx-auto h-full px-6 flex flex-col justify-center">
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-10 text-gray-600 text-base font-light">
            <a href="#presentation" className="hover:text-black transition duration-150">
              Présentation
            </a>
            <a href="#gallery" className="hover:text-black transition duration-150">
              Galerie
            </a>
            <a href="#contact" className="hover:text-black transition duration-150">
              Contact
            </a>
          </div>
        </div>
