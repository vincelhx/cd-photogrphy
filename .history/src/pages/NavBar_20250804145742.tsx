...
const Navbar: React.FC = () => {
  return (
    <nav className="max-w-6xl bg-white mx-auto px-6 h-16 flex items-center justify-between">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        {/* Nom */}
        <div className="text-lg font-bold text-gray-800">Célia Dupont</div>

        {/* Liens */}
        <div className="flex gap- text-gray-700 text-center space-x-8 text-sm font-medium">
