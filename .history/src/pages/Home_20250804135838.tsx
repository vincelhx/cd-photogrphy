...
const Home: React.FC = () => {
  return (
    <div className="font-sans text-gray-800 overflow-x-hidden scroll-smooth pt-100">
      <Navbar />
      ...
      <main className="pt-20">
        ...
        <section
          ...
          <div className="bg-white/80 backdrop-blur-sm text-gray-800 p-8 rounded-md shadow-lg max-w-2xl text-center">
