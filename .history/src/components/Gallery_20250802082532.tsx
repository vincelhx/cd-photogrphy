          ...
          return (
            <div
              ...
              {index === activeIndex && (
                <button
                  onClick={shiftLeft}
                  className="absolute left-8 top-1/2 -translate-y-1/2 z-50 bg-white text-black font-bold rounded-full shadow border border-black px-5 py-3 text-[clamp(2rem,4vw,3rem)]">
                  ◀
                </button>
              )}
              {/* Image container */}
