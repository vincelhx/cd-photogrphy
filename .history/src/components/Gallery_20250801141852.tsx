    ...
    <div className="relative w-full h-full">
      ...
      {index === activeIndex - 1 && (
        <button
          ...
          className="absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-white/80 hover:bg-white rounded-full shadow p-2 text-xl"
        >
          ◀
        </button>
      )}
      ...
      {index === activeIndex + 1 && (
        <button
          onClick={() => scrollToIndex(activeIndex + 1)}
          className="absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-white/80 hover:bg-white rounded-full shadow p-2 text-xl"
        >
          ▶
        </button>
      )}
