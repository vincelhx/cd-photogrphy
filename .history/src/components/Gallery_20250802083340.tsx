          ...
          return (
            <div
              ...
              className={`shrink-0 w-[45vw] max-w-[700px] h-[60vh] flex flex-col justify-between bg-white rounded-xl overflow-hidden shadow-xl snap-center transition-all duration-300 ${
                index === activeIndex
                  ? "w-[60vw] max-w-[9000px] scale-100 opacity-100 blur-0 z-20 px-12"
              ...
              {index === activeIndex && (
                <button
                  onClick={shiftLeft}
                  className="absolute left-4 top-1/2 -translate-y-1/2 z-50 bg-white text-black font-bold rounded-full shadow border border-black px-5 py-3 text-[clamp(2rem,4vw,3rem)]">
                  ◀
                </button>
              )}
              {/* Image container */}
              ...
              {index === activeIndex && (
                <button
                  onClick={shiftRight}
                  className="absolute right-4 top-1/2 -translate-y-1/2 z-50 bg-white text-black font-bold rounded-full shadow border border-black px-5 py-3 text-[clamp(2rem,4vw,3rem)]">
                  ▶
                </button>
              )}
            </div>
