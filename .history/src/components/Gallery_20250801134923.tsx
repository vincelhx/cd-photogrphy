  ...
  <button
      ...
      >
        {photos.map((photo, index) => (
          <div
            key={photo.id}
            className={`shrink-0 w-[45vw] max-w-[700px] flex flex-col justify-between rounded-xl bg-white overflow-hidden shadow-xl snap-center transition-all duration-300 ${
              index === activeIndex
