...
{activeIndex > 0 && (
  <button
    ...
    className="absolute z-20 left-[calc(50%-26vw)] top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white rounded-full shadow px-3 py-2 text-2xl transition duration-200"
  >
    ◀
  </button>
)}
...
{activeIndex < photos.length - 1 && (
  <button
    ...
    className="absolute z-20 right-[calc(50%-26vw)] top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white rounded-full shadow px-3 py-2 text-2xl transition duration-200"
  >
    ▶
  </button>
)}
