    ...
    <div className="relative w-full h-[80vh] flex items-center justify-center bg-white">
      ...
      {activeIndex > 0 && (
        <button
          ...
          className="absolute z-20 left-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white rounded-full shadow px-3 py-2 text-2xl transition duration-200"
        >
          ◀
        </button>
      )}
      ...
      {activeIndex < photos.length - 1 && (
        ...
        onClick={() => {
          ...
          className="absolute z-20 right-4 top-1/4 -translate-y-1/2 bg-white/90 hover:bg-white rounded-full shadow px-3 py-12 text-2xl transition duration-200"
        >
          ▶
        </button>
      )}
