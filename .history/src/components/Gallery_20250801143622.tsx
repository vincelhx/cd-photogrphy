...
{index === activeIndex + 1 && (
  <button
    onClick={() => scrollToIndex(activeIndex + 1)}
    className="absolute top-1/2 right-1/2 translate-x-full -translate-y-1/2 z-50 bg-white text-black font-bold rounded-full shadow  border-black px-5 py-3 text-[clamp(2rem,5vw,4rem)]"
  >
    ▶
  </button>
)}
