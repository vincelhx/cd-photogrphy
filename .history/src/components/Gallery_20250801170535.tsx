              ...
              <div className="relative w-full h-full bg-black">
                ...
                {index === activeIndex && (
                  <button
                    ...
                    className="absolute left-1/5 top-1/2 -translate-y-1/2 z-50 bg-white text-black font-bold rounded-full shadow border border-black px-4 py-2 text-[clamp(2rem,4vw,3rem)]">
                    ◀
                  </button>
                )}
