  ...
  return (
    <div className="relative w-full h-[80vh] flex items-center justify-center bg-white">
      ...
      <div
        ...
        className="flex overflow-x-scroll scroll-smooth snap-x snap-mandatory gap-8 py-8 no-scrollbar px-8 snap-x touch-none snap-mandatory">
