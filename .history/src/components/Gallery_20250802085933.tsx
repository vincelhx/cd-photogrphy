            ...
            <div
              ...
              {index === activeIndex && (
                <>
                  ...
                  <button
                    onClick={shiftLeft}
                    className="absolute left-[-2.5rem] top-1/2 -translate-y-1/2 z-[40] bg-white text-black rounded-full border border-black px-5 py-3 text-[clamp(2rem,4vw,3rem)] shadow">
                    ◀
                  </button>
