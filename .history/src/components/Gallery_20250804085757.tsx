...
const Gallery: React.FC<GalleryProps> = ({ photos }) => {
  ...
  useEffect(() => {
    ...
    container.scrollTo({
      ...
      behavior: "auto", // pas "smooth" sinon bizarre au chargement
    });
  }, []);
  ...
  */
  ...
  useEffect(() => {
    ...
    container.scrollTo({
      left: scrollPosition,
      behavior: "smooth", // ou "auto" au premier montage
    });
  }, [photoList]);
  useEffect(() => {
    const container = galleryRef.current;
  ...
  return (
    <div className="relative w-full h-[80vh] flex items-center justify-center bg-white">
      ...
      <div
        ...
        className="flex overflow-x-scroll scroll-smoothgap-8 py-8 no-scrollbar px-8 snap-x touch-none snap-mandatory">
