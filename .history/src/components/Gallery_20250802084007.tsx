          ...
          return (
            <div
              ...
              className={`shrink-0 w-[45vw] max-w-[700px] h-[60vh] flex flex-col justify-between bg-white rounded-xl overflow-hidden shadow-xl snap-center transition-all duration-300 ${
                index === activeIndex
                  ? "w-[60vw] max-w-[9000px] scale-100 opacity-100 blur-0 z-2"
              ...
              {index === activeIndex && (
                <button
                  onClick={shiftLeft}
                  className="absolute left-1/4 top-1/2 -translate-y-1/2 z-50 bg-white text-black font-bold rounded-full shadow border border-black px-5 py-3 text-[clamp(2rem,4vw,3rem)]">
                  ◀
                </button>
              )}
              {/* Image container */}
              ...
              {isActive && (
                <>
                  ...
                  <button
                    onClick={shiftLeft}
                    className="absolute left-0 -translate-x-[120%] top-1/2 -translate-y-1/2 z-50 bg-white text-black rounded-full border border-black px-5 py-3 text-[clamp(2rem,4vw,3rem)] shadow">
                    ◀
                  </button>
                  ...
                  <button
                    onClick={shiftRight}
                    className="absolute right-0 translate-x-[120%] top-1/2 -translate-y-1/2 z-50 bg-white text-black rounded-full border border-black px-5 py-3 text-[clamp(2rem,4vw,3rem)] shadow">
                    ▶
                  </button>
                </>
              )}
