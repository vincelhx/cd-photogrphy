    ...
    <div className="font-sans">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-6">
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl mb-6">
            Je vous emmène dans un voyage visuel à travers les émotions, la lumière et les instants suspendus.
          </p>
          <a href="#gallery">
      ...
      <section id="gallery" className="py-20 bg-white px-6 text-center">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <img src="/photos/photo1.png" className="rounded-lg shadow-md object-cover h-64 w-full" />
          <img src="/photos/photo2.png" className="rounded-lg shadow-md object-cover h-64 w-full" />
          <img src="/photos/photo3.png" className="rounded-lg shadow-md object-cover h-64 w-full" />
        </div>
      </section>
      ...
      <section id="contact" className="py-20 bg-gray-50 px-6 text-center">
        ...
        <p className="text-lg font-medium">
          📧 <a href="mailto:contact@celiadupont.com" className="text-blue-600 underline">contact@celiadupont.com</a>
        </p>
      </section>
