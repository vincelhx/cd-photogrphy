            ...
            <div
              ...
              {index === activeIndex && (
                <>
                  ...
                  <button
                    onClick={shiftRight}
                    className="absolute right-0 translate-x-[120%] top-1/2 -translate-y-1/2 z-50 bg-red text-black rounded-full border border-black px-5 py-3 text-[clamp(2rem,4vw,3rem)] shadow">
                    ▶
                  </button>
                </>
              )}
