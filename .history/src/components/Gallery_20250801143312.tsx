  ...
  return  (
    ...
    {index === activeIndex - 1 && (
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-50 bg-red-600 text-white font-bold rounded-full shadow border-4 border-yellow-400 px-4 py-2 text-3xl"
        >
        ◀
      </button>
    )}
