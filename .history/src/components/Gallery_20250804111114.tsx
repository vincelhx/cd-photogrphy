      ...
      <div className="flex gap-6 items-center">
        {visiblePhotos.map(({ photo, key }, index) => {
          ...
          return (
            <div
              key={key}
              className={`transition-all duration-300 ease-in-out shrink-0 h-[60vh] rounded-xl shadow-xl flex flex-col justify-between bg-white
                ${
                  isActive
