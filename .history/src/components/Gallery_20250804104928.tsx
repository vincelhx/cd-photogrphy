...
const Gallery: React.FC<GalleryProps> = ({ photos }) => {
  ...
  return (
    <div className="relative w-full h-[80vh] flex items-center justify-center bg-white">
      ...
      <div
        ref={galleryRef}
        className="flex scroll-smooth gap-8 py-8 no-scrollbar"
        style={{
          overflowX: "hidden", // 👈 bloque scroll horizontal natif
          touchAction: "pan-y", // 👈 empêche scroll horizontal tactile
        }}>
