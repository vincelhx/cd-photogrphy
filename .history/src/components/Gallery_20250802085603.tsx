            ...
            <div
              ...
              {index === activeIndex && (
                <>
                  ...
                  <button
                    onClick={shiftRight}
                    className="absolute right-0 translate-[120%] top-1/2 -translate-y-1/2 z-[999] bg-white text-black rounded-full border border-black px-5 py-3 text-[clamp(2rem,4vw,3rem)] shadow">
                    ▶
                  </button>
                </>
              )}
