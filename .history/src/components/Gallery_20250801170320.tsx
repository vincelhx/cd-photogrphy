              ...
              <div className="relative w-full h-full bg-black">
                ...
                {index === activeIndex && (
                  <button
                    ...
                    className="absolute top-1/2 left -translate-x-full -translate-y-1/2 z-50 bg-white text-black font-bold rounded-full shadow border border-black px-5 py-3 text-[clamp(2rem,5vw,4rem)]">
                    ◀
                  </button>
                )}
