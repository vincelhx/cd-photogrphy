  ...
  return (
    <div className="relative w-full h-[80vh] flex items-center justify-center bg-white overflow-hidden">
      ...
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white rounded-full shadow px-3 py-2 text-2xl"
      >
        ◀
      </button>
      ...
      <button
        ...
        className="absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white rounded-full shadow px-3 py-2 text-2xl"
      >
        ▶
      </button>
    </div>
